...
//    else if ((opponentAboveMe) || (myScoreIsHigher)) {  // chase opponent closer so it cannot take your picture
        ...
        if (!opponentAboveMe) stepCloser[2] = -0.45f;
        if ((opponentExposed) && (otherZRState[1] > trailingEdge)  && (myEnergy > 3.0f)) {
...
*/    
    if (gameTime == 180) DEBUG(("!!!!!ZiRconiuM_Paly_Eagles strategy TE5 here!!!!!\n"));
